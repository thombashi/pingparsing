...
from pingparsing import __author__, __copyright__, __name__, __version__
...
#
# html_title = u'pingparsing v0.3.0'
...
htmlhelp_basename = 'pingparsingdoc'
...
latex_documents = [
    (master_doc, 'pingparsing.tex', u'pingparsing Documentation',
...
man_pages = [
    (master_doc, 'pingparsing', u'pingparsing Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pingparsing', u'pingparsing Documentation',
     author, 'pingparsing', 'One line description of project.',
     'Miscellaneous'),
]
